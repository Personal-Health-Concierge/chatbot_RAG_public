...
/*  readonly chatBuckets: ChatBotS3Buckets; */
}
  ...
  constructor(scope: Construct, id: string, props: RealtimeResolversProps) {
    ...
    const resolverFunction = new Function(this, "lambda-resolver", {
      ...
      environment: {
        ...
        /* CHAT_FILE_BUCKET_NAME: props.chatBuckets.filesBucket.bucketName */
      },
      layers: [props.shared.powerToolsLayer],
      vpc: props.shared.vpc
    });

    /* props.chatBuckets.filesBucket.grantReadWrite(resolverFunction) */
